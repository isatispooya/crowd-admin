    ...
    return (
      <div className="contract-clauses p-4 text-sm leading-relaxed">
        ...
        <p className="text-[23px]  mt-4 mb-2">
          ...
          <br />
          8-2. کارگروه ارزیابی: کارگروهی که مطابق ماده 14 دستورالعمل تامین مالی جمعی تشکیل می گردد.
          <br />
          9-2. گواهی شراکت: ورقه بهاداری است که در تامین مالی جمعی بصورت الکترونیکی به درخواست عامل
