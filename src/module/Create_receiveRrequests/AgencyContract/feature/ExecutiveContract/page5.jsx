    ...
    <div className="contract-page page-1">
      <div className="text-justify leading-relaxed text-[23px] space-y-6">
        <p className="text-[23px]">
          5-2.  در صورت افزایش عمومی نرخ سود سپرده‌های متناظر بانکی و اوراق مشابه،
        ...
        <p className="text-[23px]">
          5-3.متقاضی متعهد است حداکثر پس از دو هفته از پایان عمر گواهی‌های شراکت،
        ...
        <p className="text-[23px]">
          5-4.متقاضی تأیید و تعهد می‌کند که دعاوی مؤثر با اهمیت حقوقی یا کیفری علیه
        ...
        <p className="text-justify leading-relaxed text-[23px]">
          ...
          جریمه‌ای معادل 150 درصد مبلغ کل قرارداد به عنوان وجه التزام به عامل پرداخت نماید و عامل
