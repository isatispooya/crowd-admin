  ...
  const renderContractClauses = () => (
    <div className="contract-clauses p-4 text-[23px] leading-relaxed">
      ...
      <p className="text-justify leading-relaxed text-[23px]">
        ...
        گزارش/صورت مالی اصلاح شده در موعد مقرر که به تأیید عامل نیز رسیده باشد، عامل می‌تواند رأساً
        نسبت به فسخ قرارداد اقدام نماید و حق شکایت کیفری و حقوقی در خصوص ارائه گزارش و صورت مالی
        صوری و خلاف واقع برای عامل محفوظ است.
      </p>
    </div>
  );
