  ...
  const renderContractClauses = () => {
    ...
    return (
      <div className="contract-clauses p-4 text-sm leading-relaxed">
        <h2 className="text-lg font-bold mb-2">2. تعهد به استفاده از مبلغ تأمین مالی</h2>
        <p>
        ...
        <h2 className="text-lg font-bold mt-4 mb-2">3. مسئولیت هزینه‌های غیرمترقبه</h2>
        <p>
        ...
        <h2 className="text-lg font-bold mt-4 mb-2">ماده 5) تعهدات متقاضی</h2>

        <h3 className="text-md font-bold mt-2 mb-2">1. تسلیم چک‌های پرداخت اقساط</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">2. افزایش نرخ سود</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">3. محاسبه سود قطعی</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">4. عدم وجود دعاوی</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">5. پرداخت هزینه‌ها</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">6. اطلاع‌رسانی به عامل</h3>
        <p>
        ...
        <h3 className="text-md font-bold mt-4 mb-2">7. پرداخت مالیات</h3>
        <p>
