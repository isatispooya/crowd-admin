...
<h3 className="text-[23px] font-bold mt-4 mb-2">5. پرداخت هزینه‌ها</h3>
      ...
      <p className="text-justify leading-relaxed text-[23px]">
        ...
        جریمه‌ای معادل 2/5 درصد مبلغ کل قرارداد به عنوان وجه التزام به عامل پرداخت نماید و عامل مخیر
      ...
      <p className="text-justify leading-relaxed text-[23px]">
        ...
        عدم اجرای موضوع ماده 3، اعم از اصل به‌همراه متفرعات و وجه التزامی به میزان 2/5 درصد مبلغ کل
