...
import Artboard1Copy3 from '../../../../../public/img/Artboard 1 copy 3.png';
import signContract from '../../../../../public/img/signContract.png';
import typography from '../../../../../public/img/typography.png';
      ...
      >
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <img src={Artboard1Copy3} alt="logo" className="w-16 h-auto" />
              <img src={typography} alt="type logo" className="w-20 h-auto ml-2" />
            </div>
        ...
        >
          <div className="w-6/12">
            ...
            >
              <img
                src={bankLetter?.signature_image || signContract}
                alt="امضای بانک"
