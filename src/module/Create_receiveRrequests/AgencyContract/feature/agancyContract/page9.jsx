    ...
    <div className="contract-page page-1">
      <div className="text-justify leading-relaxed text-[23px]">
        ...
        <h3 className="font-bold mb-2 text-[23px] text-right">
          ماده13) عدم تضمین موفقیت طرح در جذب سرمایه
        </h3>
        <p className="mb-3 pr-4 text-[23px]">
        ...
        <h3 className="font-bold mb-2 text-[23px] text-right">
          ماده14) گزارش دهی متقاضی و اعمال حق نظارت عامل
        </h3>
        <p className="mb-3 pr-8 text-[23px]">
        ...
        <p className="mb-3 pr-8 text-[23px]">
          ...
          ارائه اطلاعات صحیح و معتبر مجدد ًا اقدام نماید و در این زمینه کلیه همکاری های لازم را با
