    ...
    <div className="contract-page page-1">
      <div className="text-justify leading-relaxed text-[23px]">
        <p className="mb-3 pr-8 text-[23px]">
          ...
          پولشویی (مصوب 02/11/1386 همراه با آخرین اصلاحات 15/10/1395) و هم چنین آییننامه اجرایی آن
          مصوب ،21/07/1398 تمامی اطلاعات مورد نیاز را در اختیار عامل قرار داده و نمی تواند به عذری
