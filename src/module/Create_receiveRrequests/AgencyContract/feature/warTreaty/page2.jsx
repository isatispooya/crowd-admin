    ...
    <div className="contract-page page-1">
      <div className="text-justify leading-relaxed text-[23px] ">
        <p className="text-justify leading-relaxed text-[23px]">
          1) شرکت سبدگردان ایساتیس پویا کیش (سهامی خاص) به شماره ثبت 13702 نزد اداره ثبت شرکت ها و
          مؤسسات غیرتجاری استان هرمزگان و شناسه ملی 14007805556 به نشانی کیش، میدان امیرکبیر، برج
          مالی آنا، طبقه 4 واحد 44 شماره تلفن 076-44480555 و کد پستی 7941757334 و با نمایندگی آقای
          سید علی محمد خبیری به شماره ملی 4431535474 به سمت عضو هیئت مدیره و آقای محسن زارعیان به
          شماره ملی 4431855416 به سمت مدیرعامل، به استناد روزنامه رسمی شماره 22670 مورخ 24/10/1404
          که در این قرارداد به اختصار &quot; عامل/ شرکت&quot; نامیده می شود؛
        </p>

        <p className="text-justify leading-relaxed text-[23px]">
          2) شرکت گروه سیوان تجارت یزد (سهامی خاص) به شمارۀ شناسۀ ملی 14014205223، کد اقتصادی
          ...
          ساختمان مجتمع مسكوني رزلند(ROSE LAND)، بلوك A، طبقه 4، واحد 403، کدپستی 8915834258، شماره
          تماس 38255950-035، و با نمایندگی آقای مجید حاجی زاده به شماره ملی 4420356960 به سمت
          مدیرعامل و رئیس هیئت‌مدیره به عنوان صاحب امضای مجاز بر اساس روزنامه رسمی شماره 23274
          شهرستان مورخ 29/11/1403 که در این قرارداد، &quot;متقاضی/سرمایه‌پذیر&quot; نامیده می شود،
        </p>
        <p className="text-justify leading-relaxed text-[23px]">
          3) شخص حقیقی/حقوقی با مشخصات و اطلاعات سجامی مندرج در سکوی تأمین مالی جمعی عامل به نشانی
          Isatiscrowd.ir که در این قرارداد به اختصار &quot;تأمین کننده/سرمایه گذار&quot; نامیده می
          شود.
        </p>

        <p className="text-justify leading-relaxed text-[23px]">
          <span className="font-bold">تبصره:</span> واریز وجه توسط سرمایه‌گذار از طریق سکوی تأمین
          مالی جمعی عامل و نیز تأیید متن بیانیه ریسک و قوانین و مقرراتِ مندرج در سکوی عامل به نشانی
          isatiscrowd.ir، به منزله امضای این قرارداد توسط سرمایه گذار تلقی میگردد.
        </p>

        <h3 className="text-justify leading-relaxed text-[23px]"> 2) تعاریف</h3>
        <p className="text-justify leading-relaxed text-[23px]">
        ...
        <p className="text-justify leading-relaxed text-[23px]">
          2) دستورالعمل: منظور، دستورالعمل تأمین مالی جمعی مصوب 25/02/1397 شورای عالی بورس و اوراق
        ...
        <p className="text-justify leading-relaxed text-[23px]">
          ...
          خرید داراییهای مورد نیاز به مبلغ 200،000،000،000 ریال از فروشنده مجاز، به متقاضی اعطا می
          نماید.
        </p>
        ...
        <p className="text-justify leading-relaxed text-[23px]">
          ...
          (سرمایه پذیر) به مبلغ 281،000،000،000 ریال، اقدام می نماید.
        </p>
      </div>
    </div>
  );
