  ...
  return (
    <div className="contract-page page-1">
      <p className="text-justify leading-relaxed text-[23px]">
        16) »حداقل مبلغ قابل پذیرش»: منظور، مبلغ 160،000،000،000 ریال است که در صورت جذب آن تا پایان
        دوره جمع آوری، کمپین موفق فرض می گردد.
      </p>
      <p className="text-justify leading-relaxed text-[23px]">
        17) موفقیت کمپین»: منظور، اعم از موفقیت کمپین در جذب سرمایه به میزان حداقل مبلغ قابل پذیرش و
        یا جمع آوری کامل وجوه مورد نیاز (به مبلغ 200،000،000،000 ریال)، می باشد.
      </p>
      <p className="text-justify leading-relaxed text-[23px]">
        18) »تاریخ موفقیت کمپین»: منظور، تاریخی است که در آن، طرح موفق به جذب سرمایه به میزان حداقل
        مبلغ قابل پذیرش یا جمع‌آوری کامل وجوه مورد نیاز، می شود.
      </p>
      <p className="text-justify leading-relaxed text-[23px]">
        19) »آورده شخصی»: منظور، حداقل 10 درصد سرمایه مورد نیاز (معادل مبلغ 20،000،000،000 ریال) است
        که متقاضی موظف است شخصاً نسبت به تأمین آن اقدام و ظرف مدت حداکثر 7 روز تقویمی از تاریخ
        درخواست مکتوب عامل، به شماره حساب عامل واریز نماید. انتشار فراخوان جمع آوری، منوط به واریز
        رقم مزبور توسط متقاضی می باشد.
      </p>
