...
import useAgencyContract from '../AgencyContract/hooks/useAgencyContract';
import { PAGES_APPENDIX } from './pages';
...
const Appendix = () => {
  ...
  useEffect(() => {
    ...
    pageRefs.current = Array(PAGES_APPENDIX.length)
      .fill()
      .map(() => React.createRef());
  }, [uuid]);
  ...
  return (
    <div>
      ...
      <div>
        {PAGES_APPENDIX.map((PageComponent, index) => (
          <div
            key={`page-${index}`}
